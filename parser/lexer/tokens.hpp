...
enum class TokenType {
  ...
  TOKEN_SLASH, TOKEN_BANG, TOKEN_NOT_EQUAL,
  TOKEN_ASSIGN, TOKEN_EQUAL, TOKEN_LESS,
  TOKEN_GREATER, TOKEN_LESS_EQUAL,
  TOKEN_GREATER_EQUAL, 
  ...
  TOKEN_TRUE, TOKEN_FALSE, TOKEN_FOR, TOKEN_WHILE,
  TOKEN_FUNC, TOKEN_RETURN, TOKEN_LET, TOKEN_PRINT,
  TOKEN_CLASS, TOKEN_SUPER, TOKEN_THIS, TOKEN_NIL,
