...
private:
  ...
  PEBBLObject call_builtin_function(PEBBLBuiltinFunction* func, 
                                    const std::vector<PEBBLObject>& args);
  ...
  bool perform_numeric_operation(PEBBLObject left, PEBBLObject right, 
                                 OpCode operation, PEBBLObject& result);
  bool perform_comparison_operation(PEBBLObject left, PEBBLObject right,
                                    OpCode operation, PEBBLObject& result);
};
